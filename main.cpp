 ...
 * Cargo: Estudiante Ingeniería Electrónica
 ...
 * de su moneda local por lo que se mostrará en pantalla su saldo actualizado*/
    ...
    {   cout<<"Que desea realizar? \n1.Codificacion\n2.Decodificacion\n3.Simulador Cajero."<<endl;
        ...
        case 1:
        {
            ...
            if(!lector.fail())
            {
                ...
                binario=char2bin(textoleido);//no convierto a binario lo que ya está en binario
                escritor.close();
                lector.close();
                cout<<"\nTexto obtenido: \n";
        ...
        {   //contrasena SUDO: 17860,semilla=4,metodo=2
            ...
            else//codigo para cuando el usuario ingresa como normal
            {
                ...
                while(opnormal!=3)
                {
                    ...
                    else if(opnormal==2)//cuando usuario elege retirar saldo
                    {
...
//------------------------------segundo metodo de codificación--------------------------------------
